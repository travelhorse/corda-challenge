...
import net.corda.samples.supplychain.states.OrderMessageState;
...
@InitiatingFlow
@StartableByRPC
public class OrderMessage extends FlowLogic<String> {
    ...
    //public constructor
    public OrderMessage(String fromWho, String whereTo, String order){
        this.whoAmI = fromWho;
    ...
    public String call() throws FlowException {
        ...
        OrderMessageState output = new OrderMessageState(order,new AnonymousParty(myKey),targetAcctAnonymousParty);
        ...
        TransactionBuilder txbuilder = new TransactionBuilder(notary)
                ...
                .addCommand(new OrderMessageStateContract.Commands.Create(),Arrays.asList(targetAcctAnonymousParty.getOwningKey(),myKey));
        ...
        return "Inform " + targetAccount.getName() + " to " + order + ".";
    }
}


@InitiatedBy(OrderMessage.class)
class OrderMessageResponder extends FlowLogic<Void> {
    //private variable
    private FlowSession counterpartySession;

    //Constructor
    public OrderMessageResponder(FlowSession counterpartySession) {
